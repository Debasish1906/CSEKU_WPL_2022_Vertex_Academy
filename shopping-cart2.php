    ...
    ?>
                                ...
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-md-3">
                                            <div class="product-image"><img class="img-fluid d-block mx-auto image" src="<?php echo $img;?>"></div>
                                        </div>
                                        <div class="col-md-5 product-info"><a class="product-name" href="#"><?php echo $course_name;?></a>
                                            <div class="product-specs">
                                                <div><span>Teacher:&nbsp;</span><span class="value">Rais Rahman</span></div>
                                                <div><span>Videos:&nbsp;</span><span class="value">25 hours</span></div>
                                                <div><span>Feedback:&nbsp;</span><span class="value">Excellent</span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-md-2 price"><span><?php echo $price;?></span></div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-md-3">
                                            <div class="product-image"><img class="img-fluid d-block mx-auto image" src="assets/img/image-62516-1653314935.jpg"></div>
                                        </div>
                                        <div class="col-md-5 product-info"><a class="product-name" href="#">Cyber Security</a>
                                            <div class="product-specs">
                                                <div><span>Teacher:&nbsp;</span><span class="value">Rais Rahman</span></div>
                                                <div><span>Videos:&nbsp;</span><span class="value">74 hours</span></div>
                                                <div><span>Feedback:&nbsp;</span><span class="value">Very Good</span></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-2 quantity"><label class="d-none d-md-block" for="quantity">Quantity</label><input type="number" id="number" class="form-control quantity-input" value="1"></div>
                                        <div class="col-6 col-md-2 price"><span>$100</span></div>
                                    </div>
                                </div>
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-md-3">
                                            <div class="product-image"><img class="img-fluid d-block mx-auto image" src="assets/img/software-development-business-process-automation-internet-technology-concept-virtual-screen-software-development-143587196.jpg"></div>
                                        </div>
                                        <div class="col-md-5 product-info"><a class="product-name" href="#">Software development</a>
                                            <div class="product-specs">
                                                <div><span>Teacher:&nbsp;</span><span class="value">Debasis Biswash</span></div>
                                                <div><span>Videos:&nbsp;</span><span class="value">45 hours</span></div>
                                                <div><span>Feedback:&nbsp;</span><span class="value">Exvellent</span></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-2 quantity"><label class="d-none d-md-block" for="quantity">Quantity</label><input type="number" id="number" class="form-control quantity-input" value="1"></div>
                                        <div class="col-6 col-md-2 price"><span>$100</span></div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="summary">
                                <h3>Summary</h3>
                                <!-- <h4><span class="text">Subtotal</span><span class="price"></span></h4>
                                <h4><span class="text">Discount</span><span class="price">$0</span></h4> -->
                                <h4><span class="text">Total</span><span class="price"><?php echo $total_price;?></span></h4>
                                <a class="btn btn-outline-primary btn-sm" href="payment-page2.php?course_id='$id'" role="button">Buy Now</a>
<!--                                <button class="btn btn-primary btn-block btn-lg" type="button">Enroll Now</button></div>-->
                        </div>
                    </div>
                </div>
            </div>
