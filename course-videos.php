        ...
        <section class="clean-block clean-blog-list dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Courses Videos</h2>
                    <p><br>Here all classes are conducted by qualified teachers.<br><br></p>
                </div>
                    ...
                    if($result){
                      while($row=mysqli_fetch_assoc($result)){
                          ...
                          $img = 'uploaded_img/'.$course_image;
                           $course_link = $row['video_link'];
                           
                           
                          
                          echo' <div class="clean-blog-post">
                        <div class="row">
                            <div class="col-lg-5"><img class="rounded img-fluid" src='.$img.'></div>
                            <div class="col-lg-7">
                                <h3>'.$course_name.'</h3>
                                <div class="info"><span class="text-muted">July 16, 2022 by<a href="#"> Shaikh Rais Rahman</span></div>
                                <p class="text-capitalize">By watching this video it will be possible to understand everything about chemistry based religion</p><a class="btn btn-outline-primary btn-sm" type="button" href='.$course_link.' target="_blank">Watch Videos</a></div>
                        </div>
                    </div>';
...
<!--
                    <div class="clean-blog-post">
                        <div class="row">
                            <div class="col-lg-5"><img class="rounded img-fluid" src="assets/img/Screenshot%202022-08-04%20013540.png"></div>
                            <div class="col-lg-7">
                                <h3>Physics Class (SSC)</h3>
                                <div class="info"><span class="text-muted">Jan 16, 2022 by<a href="#">Dedasis Biswash</a></span></div>
                                <p>Basic of Physics.&nbsp;</p><button class="btn btn-outline-primary btn-sm" type="button">Watch Videos</button></div>
                        </div>
                    </div>
                    <div class="clean-blog-post">
                        <div class="row">
                            <div class="col-lg-5"><img class="rounded img-fluid" src="assets/img/Screenshot%202022-08-04%20013440.png"></div>
                            <div class="col-lg-7">
                                <h3>Physics Class (HSC)</h3>
                                <div class="info"><span class="text-muted">Jan 20, 2022 by&nbsp;<a href="#">MD Mehedi Hasan</a></span></div>
                                <p>Pure Basics of Current,Circuits &amp; Voltage.</p><a class="btn btn-outline-primary btn-sm" type="button" href="<?php echo $data['video_link'];?>" target="_blank">Watch VIdeos</a></div>
                        </div>
                    </div>
                    <div class="clean-blog-post">
                        <div class="row">
                            <div class="col-lg-5"><img class="rounded img-fluid" src="assets/img/Screenshot%202022-08-04%20013653.png"></div>
                            <div class="col-lg-7">
                                <h3>Math Class (SSC)</h3>
                                <div class="info"><span class="text-muted">Aug 1, 2022 by&nbsp;<a href="#">Noor Mohammad</a></span></div>
                                <p class="text-capitalize">A Must Watch Video for every science students</p><button class="btn btn-outline-primary btn-sm" type="button">Watch Videos</button></div>
                        </div>
                    </div>
-->
                </div>
